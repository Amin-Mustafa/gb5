...
namespace Operation {
    ...
    namespace Primitive {
    void load_8_bit(uint8_t& dest, uint8_t& src){
        dest = src;
    }
    void inc_8_bit(uint8_t& num, FlagRegister& fr){
...
inline Instruction LD_8_mem_r(MMU& mmu, uint16_t addr, uint8_t& src) {
    return Instruction {
        [&](){mmu.write(addr, src);},
        1, 8
    };
}
inline Instruction LD_8_r_mem(uint8_t& dest, MMU& mmu, uint16_t addr) {
    return Instruction {
        [&](){dest = mmu.read(addr);},
        1, 8
    };
...
inline Instruction INC_8_mem(MMU& mmu, uint16_t addr, FlagRegister& fr) {
    return Instruction{ 
        [&](){
...
inline Instruction ADD_8_reg(uint8_t& num1, uint8_t& num2, FlagRegister& fr) {
    return Instruction { 
        [&](){ Primitive::add_8_bit(num1, num2, 0, fr); },
        1,4
    };
}
inline Instruction ADD_8_mem(uint8_t& num1, MMU& mmu, uint16_t addr, FlagRegister& fr) {
    return Instruction { 
        [&](){
...
inline Instruction ADC_8_reg(uint8_t& num1, uint8_t& num2, FlagRegister& fr) {
    return Instruction { 
        [&](){ Primitive::add_8_bit(num1, num2, fr.get_flag(Flag::CARRY), fr); },
        1,4
    };
}
inline Instruction ADC_8_mem(uint8_t& num1, MMU& mmu, uint16_t addr, FlagRegister& fr) {
    return Instruction { 
        [&](){
            uint8_t num2 = mmu.read(addr);
            Primitive::add_8_bit(num1, num2, fr.get_flag(Flag::CARRY), fr);
...
inline Instruction ADC_8_imm(uint8_t& num1, uint8_t num2, FlagRegister& fr) {
    return Instruction { 
        [&](){Primitive::add_8_bit(num1, num2, fr.get_flag(Flag::CARRY), fr);}, 
        2,8 
    };
...
inline Instruction SUB_8_reg(uint8_t& num1, uint8_t& num2, FlagRegister& fr) {
    return Instruction{ 
        [&](){Primitive::sub_8_bit(num1, num2, 0, fr);}, 
        1,4 
    };
}
inline Instruction SUB_8_mem(uint8_t& num1, MMU& mmu, uint16_t addr, FlagRegister& fr) {
    return Instruction{
        [&](){
            uint8_t num2 = mmu.read(addr);
            Primitive::sub_8_bit(num1, num2, 0, fr);
...
inline Instruction SUB_8_imm(uint8_t& num1, uint8_t num2, FlagRegister& fr) {
    return Instruction{ 
        [&](){Primitive::sub_8_bit(num1, num2, 0, fr);},
        2,8
    };
}
inline Instruction SBB_8_reg(uint8_t& num1, uint8_t& num2, FlagRegister& fr) {
    return Instruction{ 
        [&](){Primitive::sub_8_bit(num1, num2, fr.get_flag(Flag::CARRY), fr);}, 
        1,4 
    };
}
inline Instruction SBB_8_mem(uint8_t& num1, MMU& mmu, uint16_t addr, FlagRegister& fr) {
    return Instruction{
        [&](){
            uint8_t num2 = mmu.read(addr);
            Primitive::sub_8_bit(num1, num2, fr.get_flag(Flag::CARRY), fr);
...
inline Instruction SBB_8_imm(uint8_t& num1, uint8_t num2, FlagRegister& fr) {
    return Instruction{ 
        [&](){Primitive::sub_8_bit(num1, num2, fr.get_flag(Flag::CARRY), fr);},
        2,8
    };
...
inline Instruction DEC_8_mem(MMU& mmu, uint16_t addr, FlagRegister& fr){
    return Instruction{ 
        [&](){
...
inline Instruction AND_8_mem(uint8_t& num1, MMU& mmu, uint16_t addr, FlagRegister& fr){
    return Instruction{
        [&](){
            uint8_t num2 = mmu.read(addr);
            Primitive::and_8_bit(num1, num2, fr);
...
inline Instruction OR_8_mem(uint8_t& num1, MMU& mmu, uint16_t addr, FlagRegister& fr){
    return Instruction{
        [&](){
            uint8_t num2 = mmu.read(addr);
            Primitive::or_8_bit(num1, num2, fr);
...
inline Instruction XOR_8_mem(uint8_t& num1, MMU& mmu, uint16_t addr, FlagRegister& fr){
    return Instruction{
        [&](){
            uint8_t num2 = mmu.read(addr);
            Primitive::xor_8_bit(num1, num2, fr);
...
inline Instruction CP_8_mem(uint8_t& num1, MMU& mmu, uint16_t addr, FlagRegister& fr){
    return Instruction{
        [&](){
            uint8_t num2 = mmu.read(addr);
            Primitive::compare_8_bit(num1, num2, fr);
