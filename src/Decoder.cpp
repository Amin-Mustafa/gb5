...
void Decoder::init_instruction_table() {
    ...
    inst_table[0x18] = cpu.JR(imm8, true);
    inst_table[0x19] = ADD_16(HL, BC, cpu.F);
    inst_table[0x1A] = LD_8(cpu.A, BC_mem);
    inst_table[0x1B] = DEC_16(BC);
    inst_table[0x1C] = INC_8(cpu.C, cpu.F);
    inst_table[0x1D] = DEC_8(cpu.C, cpu.F);
    inst_table[0x1E] = LD_8(cpu.C, imm8);
    ...
    inst_table[0x20] = cpu.JR(imm8, !cpu.F.get_flag(Flag::ZERO));
    ...
    inst_table[0x28] = cpu.JR(imm8, cpu.F.get_flag(Flag::ZERO));
    ...
    inst_table[0x30] = cpu.JR(imm8, !cpu.F.get_flag(Flag::CARRY));
    ...
    inst_table[0x38] = cpu.JR(imm8, cpu.F.get_flag(Flag::CARRY));
    ...
    inst_table[0xC0] = cpu.RET_IF(!cpu.F.get_flag(Flag::ZERO));
    inst_table[0xC1] = cpu.POP(BC);
    inst_table[0xC2] = cpu.JP(imm16, !cpu.F.get_flag(Flag::ZERO));
    inst_table[0xC3] = cpu.JP(imm16);
    inst_table[0xC4] = cpu.CALL(imm16, !cpu.F.get_flag(Flag::ZERO));
    inst_table[0xC5] = cpu.PUSH(BC);
    inst_table[0xC6] = ADD_8(cpu.A, imm8, cpu.F);
    inst_table[0xC7] = cpu.RST(0x00);
    inst_table[0xC8] = cpu.RET_IF(cpu.F.get_flag(Flag::ZERO));
    inst_table[0xC9] = cpu.RET();
    inst_table[0xCA] = cpu.JP(imm16, cpu.F.get_flag(Flag::ZERO));
    inst_table[0xCB] = NOP();  //TODO: PREFIX
    inst_table[0xCC] = cpu.CALL(imm16, cpu.F.get_flag(Flag::ZERO));
    inst_table[0xCD] = cpu.CALL(imm16);
    inst_table[0xCE] = ADC_8(cpu.A, imm8, cpu.F);
    inst_table[0xCF] = cpu.RST(0x08);

    inst_table[0xD0] = cpu.RET_IF(!cpu.F.get_flag(Flag::CARRY));
    inst_table[0xD1] = cpu.POP(DE);
    inst_table[0xD2] = cpu.JP(imm16, !cpu.F.get_flag(Flag::CARRY));
    inst_table[0xD3] = NOP();
    inst_table[0xD4] = cpu.CALL(imm16, !cpu.F.get_flag(Flag::CARRY));
    inst_table[0xD5] = cpu.PUSH(DE);
    inst_table[0xD6] = SUB_8(cpu.A, imm8, cpu.F);
    inst_table[0xD7] = cpu.RST(0x10);
    inst_table[0xD8] = cpu.RET_IF(cpu.F.get_flag(Flag::CARRY));
    inst_table[0xD9] = cpu.RETI();
    inst_table[0xDA] = cpu.JP(imm16, cpu.F.get_flag(Flag::CARRY));
    inst_table[0xDB] = NOP();  
    inst_table[0xDC] = cpu.CALL(imm16, cpu.F.get_flag(Flag::CARRY));
    inst_table[0xDD] = NOP();
